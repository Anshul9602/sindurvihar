<div class="container mx-auto px-4 py-12 max-w-md">
    <div class="bg-white shadow-lg rounded-lg p-8">
        <h1 class="text-3xl font-bold mb-6 text-center" style="color: #0F1F3F;">
            <?= esc(lang('App.adminLoginTitle')) ?>
        </h1>

        <form id="admin-login-form" class="space-y-4">
            <div>
                <label for="admin-user" class="block text-sm font-medium mb-1"><?= esc(lang('App.adminUsernameLabel')) ?></label>
            ...
            <div>
                <label for="admin-pass" class="block text-sm font-medium mb-1"><?= esc(lang('App.adminPasswordLabel')) ?></label>
