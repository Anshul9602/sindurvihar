<div class="container mx-auto px-4 py-12 max-w-md">
    <div class="bg-white shadow-lg rounded-lg p-8">
        ...
        <form id="admin-register-form" action="<?= site_url('admin/register') ?>" method="POST" class="space-y-4">
            <div>
            ...
            <p class="text-center text-sm mt-4" style="color:#4B5563;">
                <?= esc(lang('App.adminHaveAccount') ?? 'Already have an admin account?') ?>
                <a href="<?= site_url('admin/login') ?>" class="text-blue-600 hover:underline">
                    <?= esc(lang('App.adminLoginLink') ?? 'Go to Admin Login') ?>
                </a>
            </p>
        </form>
    </div>
